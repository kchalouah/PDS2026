...
export const metadata: Metadata = {
  title: "MedInsight - E-Health Platform",
  description: "Modern healthcare platform connecting patients with healthcare providers. Manage medical records, book appointments, and access quality healthcare services.",
};
