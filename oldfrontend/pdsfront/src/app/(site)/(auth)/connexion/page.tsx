...
export default function ConnexionPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            localStorage.setItem('medinsight_user', JSON.stringify(response));
        ...
        <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 via-white to-purple-50 px-4">
            <div className="max-w-md w-full space-y-8 bg-white p-10 rounded-2xl shadow-2xl border border-gray-100">
                <div className="text-center">
                    ...
                    <p className="text-gray-600">Connectez-vous à MedInsight E-Health</p>
                </div>
                ...
                <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
                    ...
                    <div className="text-center mt-4">
                        <p className="text-sm text-gray-600">
                            ...
                            <Link href="/inscription" className="font-medium text-blue-600 hover:text-blue-500 transition-colors">
                                S'inscrire
                            </Link>
                        </p>
                    </div>
