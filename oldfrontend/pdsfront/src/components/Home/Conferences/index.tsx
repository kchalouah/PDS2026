          ...
          <div className="grid md:grid-cols-2 grid-cols-1 items-center lg:gap-24 gap-5">
            ...
            >
              ...
              <p className="text-lg font-normal text-SlateBlueText dark:text-opacity-80 max-w-506 md:pt-9 pt-5 md:pb-14 pb-6">
                Access your medical records anytime, book appointments with healthcare professionals,
                communicate securely with your doctors, and manage your health journey all in one place.
              </p>
              <Link
                href="/documentation"
